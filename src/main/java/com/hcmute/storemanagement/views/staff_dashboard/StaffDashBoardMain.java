 ...
 * @author thieu
 */
public class StaffDashBoardMain extends javax.swing.JPanel {
    ...
    /**
     * Creates new form StaffDashBoardMain
     */
    public StaffDashBoardMain() {
        initComponents();
    ...
    private void testData() {
        ...
        int ID = 1;
        for (int i = 0; i <= 5; i++) {
            home.addItem(new ModelItem(ID++, "Iphone 15", "This product is excluded from all promotional discounts and offers.", 160, "Iphone", new ImageIcon(System.getProperty("user.dir") + "\\src\\main\\java\\com\\hcmute\\storemanagement\\ultis\\image\\Iphone15.png")));
