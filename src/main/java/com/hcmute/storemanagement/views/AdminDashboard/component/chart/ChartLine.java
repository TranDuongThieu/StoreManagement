package com.hcmute.storemanagement.views.AdminDashboard.component.chart;
...
public class ChartLine extends javax.swing.JPanel {
    ...
    private void initData() {
        ...
        if (model != null) {
            for (ModelChartLine data : model) {
                ...
                panelData.add(new com.hcmute.storemanagement.views.AdminDashboard.chart.ItemChartLine(data));
            }
        }
    }
    ...
    private void initComponents() {
        ...
        panelChartLine = new com.hcmute.storemanagement.views.AdminDashboard.chart.PanelChartLine();
    ...
    private com.hcmute.storemanagement.views.AdminDashboard.chart.PanelChartLine panelChartLine;
