...
public class GRNTable extends JTable {
    ...
    public GRNTable() {
        ...
        setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable jtable, Object o, boolean selected, boolean focus, int i, int i1) {
                if (o instanceof ModelProfileGRN) {
                    ModelProfileGRN data = (ModelProfileGRN) o;
                    ProfileGRN cell = new ProfileGRN(data);
                    if (selected) {
                    ...
                    return cell;
                } else if (o instanceof ModelActionGRN) {
                    ModelActionGRN data = (ModelActionGRN) o;
