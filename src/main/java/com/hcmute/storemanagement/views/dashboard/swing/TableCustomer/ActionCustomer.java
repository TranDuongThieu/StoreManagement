package com.hcmute.storemanagement.views.dashboard.swing.TableCustomer;
...
public class ActionCustomer extends javax.swing.JPanel {

    public ActionCustomer(ModelActionUser data) {
        setOpaque(true);
        initComponents();
